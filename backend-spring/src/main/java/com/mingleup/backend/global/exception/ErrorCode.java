...
public enum ErrorCode {
    ...
    // Auth (인증)
    INVALID_TOKEN(HttpStatus.UNAUTHORIZED, "AUTH4001", "인증에 실패했습니다."),
    EXPIRED_TOKEN(HttpStatus.UNAUTHORIZED, "AUTH4002", "인증에 실패했습니다."),
    AUTHENTICATION_FAILED(HttpStatus.UNAUTHORIZED, "AUTH4003", "인증에 실패했습니다."),
    FORBIDDEN(HttpStatus.FORBIDDEN, "AUTH4004", "인가에 실패했습니다."),

    // User (사용자)
    USER_NOT_FOUND(HttpStatus.NOT_FOUND, "USER4004", "데이터를 찾을 수 없습니다."),
